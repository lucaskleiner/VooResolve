<div class="app-main__outer">
        <div class="app-main__inner">
            ...
            <?php 
                   ...
                   <div class="app-page-title">
                    <div class="page-title-wrapper">
                        <div class="page-title-heading">
                            <div><b class="text-primary">Status da analise</b><br>
                                <?php echo utf8_encode('Titulo da análise'); ?> : <?php echo $selEx['ex_title']; ?><br><br>
                               <span class="border" style="padding:10px;color:white;background-color: green;">Aprovado</span>
                               <span class="border" style="padding:10px;color:white;background-color: blue;">Razoavel</span>
                               <span class="border" style="padding:10px;color:white;background-color: red;">Reprovado</span>
                               <span class="border" style="padding:10px;color:black;background-color: #E9ECEE;"><?php echo utf8_encode('Não respondeu'); ?></span>
                            </div>
                        </div>
                    </div>
                    </div>
                ...
                <div class="page-title-wrapper">
                    <div class="page-title-heading">
                        <div><b>Status de elegibilidade</b></div>
                    </div>
                </div>
                </div> 
                ...
                <div class="main-card mb-3 card">
                    <div class="card-header"><?php echo utf8_encode('Lista de Análises'); ?>
                    </div>
                    <div class="table-responsive">
                        <table class="align-middle mb-0 table table-borderless table-striped table-hover" id="tableList">
                            <thead>
                            <tr>
                                <th class="text-left pl-4"><?php echo utf8_encode('Titulo'); ?></th>
                                <th class="text-left ">Problema</th>
                                <th class="text-left "><?php echo utf8_encode('Introdução'); ?></th>
