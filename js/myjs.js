...
$(document).on("click","#startQuiz", function(){
	  ...
	  Swal.fire({
      title: 'Vamos comecar?',
      text: 'Responda a nossa analise e saiba se possui direito a indenizacao',
      icon: 'warning',
      showCancelButton: true,
      confirmButtonColor: '#3085d6',
      cancelButtonColor: '#d33',
      confirmButtonText: 'Sim, vamos la!'
 }).then((result) => {
  if (result.value) {
         $.ajax({
          type : "post",
          ...
          success : function(data){
            ...
            {
              window.location.href="home.php?pagina=elegibilidade&id="+thisId;
              return false;
            }
          },
